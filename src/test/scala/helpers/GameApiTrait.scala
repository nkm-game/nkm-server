...
trait GameApiTrait extends LobbyApiTrait
  {
    ...
    override def checkActorAndDatabaseIntegrity(): Unit = {
//      val gameActor: ActorRef = system.actorOf(Game.props(lobbyId))
//      val gameStateFuture = (gameActor ? Game.GetState).mapTo[GameState]
      // TODO
    }
  }
